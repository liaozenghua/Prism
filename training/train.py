...
from trainer import ChatTrainer
...
class TrainingConfig:
    model_name: str = field(default="", metadata={"help": 'Huggingface Name of the model you want to train'})
    data_path: str = field(default="", metadata={"help": 'Path towards your training data'})
    output_dir: str = field(default='', metadata={"help": 'The output dir for logs and checkpoints'})
    training_recipe: str = field(default="full_training", metadata={"help": "Lora Training or Full Training"})
