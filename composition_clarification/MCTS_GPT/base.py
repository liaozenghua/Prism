...
class treeNode(object):
    def __init__(self, pcd,answer, parent=None, depth=0):
        self.pcd = pcd  # str
        self.y = ''  # str
    ...
    def append_children(self, new_pcd: str,new_answer):
        node = treeNode(new_pcd, new_answer,self, self.depth + 1)
    ...
    def update_y_from_parent(self):
        if self.parent is None:
            ...
            self.y = self.parent.y+'\n' + self.pcd if self.y!= '' else self.pcd
